 ...
 *
 * <p>Separe de {@link VerificationPersistenceAdapter} car {@code MembershipRepository}
 * et {@code KycDocumentRepository} declarent toutes deux {@code findById(Long)}
...
public class MembershipPersistenceAdapter implements MembershipRepository {
    ...
    public MembershipPersistenceAdapter(MembershipJpaRepository membershipJpa, VerificationPersistenceMapper mapper) {
