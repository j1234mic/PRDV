...
/**
 * Adapteur JPA des permissions.
 *
 * <p>Separe de {@link RbacPersistenceAdapter} car {@code PermissionRepository}
 * et {@code RoleRepository} declarent toutes deux {@code findAll()} avec des
...
public class PermissionPersistenceAdapter implements PermissionRepository {
    ...
    public PermissionPersistenceAdapter(PermissionJpaRepository permissionJpa, UserPersistenceMapper userMapper) {
